...
typedef enum GreasePencilModifierType {
	eGreasePencilModifierType_None      = 0,
	eGreasePencilModifierType_Noise     = 1,
	eGreasePencilModifierType_Subdiv    = 2,
	eGreasePencilModifierType_Thick     = 3,
	eGreasePencilModifierType_Tint      = 4,
	eGreasePencilModifierType_Instance  = 5,
	eGreasePencilModifierType_Build     = 6,
	eGreasePencilModifierType_Opacity   = 7,
	eGreasePencilModifierType_Color     = 8,
	eGreasePencilModifierType_Lattice   = 9,
	eGreasePencilModifierType_Simplify  = 10,
	eGreasePencilModifierType_Smooth    = 11,
	eGreasePencilModifierType_Hook      = 12,
	eGreasePencilModifierType_Offset    = 13,
	NUM_GREASEPENCIL_MODIFIER_TYPES
} GreasePencilModifierType;

typedef enum GreasePencilModifierMode {
	eGreasePencilModifierMode_Realtime          = (1 << 0),
	eGreasePencilModifierMode_Render            = (1 << 1),
	eGreasePencilModifierMode_Expanded          = (1 << 2),
} GreasePencilModifierMode;

typedef struct GreasePencilModifierData {
	struct GreasePencilModifierData *next, *prev;
	...
	char *error;
} GreasePencilModifierData;

typedef enum {
	eSubsurfGreasePencilModifierFlag_Incremental  = (1 << 0),
	eSubsurfGreasePencilModifierFlag_DebugIncr    = (1 << 1),
	eSubsurfGreasePencilModifierFlag_ControlEdges = (1 << 2),
	eSubsurfGreasePencilModifierFlag_SubsurfUv    = (1 << 3),
} SubsurfGreasePencilModifierFlag;

typedef struct NoiseGreasePencilModifierData {
	GreasePencilModifierData modifier;
...
typedef struct SubdivGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	int pass_index;               /* custom index for passes */
	int flag;                    /* flags */
	...
	char pad[4];
} SubdivGreasePencilModifierData;
...
typedef struct ThickGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	char vgname[64];             /* optional vertexgroup name, MAX_VGROUP_NAME */
	int pass_index;               /* custom index for passes */
...
typedef struct TintGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	int pass_index;               /* custom index for passes */
	int flag;                    /* flags */
...
typedef struct ColorGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	int pass_index;               /* custom index for passes */
	int flag;                    /* flags */
...
typedef struct OpacityGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	char vgname[64];             /* optional vertexgroup name, MAX_VGROUP_NAME */
	int pass_index;               /* custom index for passes */
	...
	char pad[4];
} OpacityGreasePencilModifierData;
...
typedef struct InstanceGreasePencilModifierData {
	GreasePencilModifierData modifier;
	...
	int pass_index;              /* custom index for passes */
	char layername[64];          /* layer name */
} InstanceGreasePencilModifierData;
...
typedef struct BuildGreasePencilModifierData {
	GreasePencilModifierData modifier;
...
typedef struct LatticeGreasePencilModifierData {
	GreasePencilModifierData modifier;
...
} LatticeGreasePencilModifierData;
...
typedef struct HookGreasePencilModifierData {
	GreasePencilModifierData modifier;
	...
	int flag;
	char falloff_type;      /* use enums from WarpGreasePencilModifier (exact same functionality) */
	char pad[3];
...
typedef struct SimplifyGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	int pass_index;               /* custom index for passes */
	int flag;                    /* flags */
...
} SimplifyGreasePencilModifierData;
...
typedef struct OffsetGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	char vgname[64];             /* optional vertexgroup name, MAX_VGROUP_NAME */
	int pass_index;               /* custom index for passes */
	...
	float scale[3];
	char pad[4];
} OffsetGreasePencilModifierData;
...
typedef struct SmoothGreasePencilModifierData {
	GreasePencilModifierData modifier;
	char layername[64];          /* layer name */
	char vgname[64];             /* optional vertexgroup name, MAX_VGROUP_NAME */
	int pass_index;              /* custom index for passes */
...
} SmoothGreasePencilModifierData;
