...
/** \file blender/makesrna/intern/rna_greasepencil_modifier.c
 *  \ingroup RNA
 */
...
const EnumPropertyItem rna_enum_object_greasepencil_modifier_type_items[] = {
	{0, "", 0, N_("Generate"), "" },
	{eGreasePencilModifierType_Instance, "GP_INSTANCE", ICON_MOD_ARRAY, "Instance", "Create grid of duplicate instances"},
	{eGreasePencilModifierType_Build, "GP_BUILD", ICON_MOD_BUILD, "Build", "Create duplication of strokes"},
	{eGreasePencilModifierType_Simplify, "GP_SIMPLIFY", ICON_MOD_DECIM, "Simplify", "Simplify stroke reducing number of points"},
	{eGreasePencilModifierType_Subdiv, "GP_SUBDIV", ICON_MOD_SUBSURF, "Subdivide", "Subdivide stroke adding more control points"},
	{0, "", 0, N_("Deform"), "" },
	{eGreasePencilModifierType_Hook, "GP_HOOK", ICON_HOOK, "Hook", "Deform stroke points using objects"},
	{eGreasePencilModifierType_Lattice, "GP_LATTICE", ICON_MOD_LATTICE, "Lattice", "Deform strokes using lattice"},
	{eGreasePencilModifierType_Noise, "GP_NOISE", ICON_RNDCURVE, "Noise", "Add noise to strokes"},
	{eGreasePencilModifierType_Offset, "GP_OFFSET", ICON_MOD_DISPLACE, "Offset", "Change stroke location, rotation or scale"},
	{eGreasePencilModifierType_Smooth, "GP_SMOOTH", ICON_MOD_SMOOTH, "Smooth", "Smooth stroke"},
	{eGreasePencilModifierType_Thick, "GP_THICK", ICON_MAN_ROT, "Thickness", "Change stroke thickness"},
	{0, "", 0, N_("Color"), "" },
	{eGreasePencilModifierType_Color, "GP_COLOR", ICON_GROUP_VCOL, "Hue/Saturation", "Apply changes to stroke colors"},
	{eGreasePencilModifierType_Opacity, "GP_OPACITY", ICON_MOD_MASK, "Opacity", "Opacity of the strokes"},
	{eGreasePencilModifierType_Tint, "GP_TINT", ICON_COLOR, "Tint", "Tint strokes with new color"},
	{0, NULL, 0, NULL, NULL}
};
...
static StructRNA *rna_GreasePencilModifier_refine(struct PointerRNA *ptr)
{
	...
	switch ((GreasePencilModifierType)md->type) {
		...
		case eGreasePencilModifierType_Subdiv:
			return &RNA_SubdivGreasePencilModifier;
		case eGreasePencilModifierType_Simplify:
			return &RNA_SimplifyGreasePencilModifier;
		case eGreasePencilModifierType_Thick:
			return &RNA_ThickGreasePencilModifier;
		case eGreasePencilModifierType_Tint:
			return &RNA_TintGreasePencilModifier;
		case eGreasePencilModifierType_Color:
			return &RNA_ColorGreasePencilModifier;
		case eGreasePencilModifierType_Instance:
			return &RNA_InstanceGreasePencilModifier;
		case eGreasePencilModifierType_Build:
			return &RNA_BuildGreasePencilModifier;
		case eGreasePencilModifierType_Opacity:
			return &RNA_OpacityGreasePencilModifier;
		case eGreasePencilModifierType_Lattice:
			return &RNA_LatticeGreasePencilModifier;
		case eGreasePencilModifierType_Smooth:
			return &RNA_SmoothGreasePencilModifier;
...
static void rna_GreasePencilModifier_name_set(PointerRNA *ptr, const char *value)
{
	GreasePencilModifierData *gmd = ptr->data;
...
static char *rna_GreasePencilModifier_path(PointerRNA *ptr)
{
	GreasePencilModifierData *gmd = ptr->data;
...
static void rna_GreasePencilModifier_update(Main *UNUSED(bmain), Scene *UNUSED(scene), PointerRNA *ptr)
{
	DEG_id_tag_update(ptr->id.data, OB_RECALC_DATA);
	WM_main_add_notifier(NC_OBJECT | ND_MODIFIER, ptr->id.data);
}

static void rna_GreasePencilModifier_dependency_update(Main *bmain, Scene *scene, PointerRNA *ptr)
{
	rna_GreasePencilModifier_update(bmain, scene, ptr);
...
static void rna_##_type##GreasePencilModifier_##_prop##_set(PointerRNA *ptr, PointerRNA value)          \
{                                                                                           \
	_type##GreasePencilModifierData *tmd = (_type##GreasePencilModifierData *)ptr->data;                            \
...
static void rna_HookGreasePencilModifier_object_set(PointerRNA *ptr, PointerRNA value)
{
	HookGreasePencilModifierData *hmd = ptr->data;
	Object *ob = (Object *)value.data;
...
static void rna_def_modifier_gpencilnoise(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "NoiseGreasePencilModifierData");
	...
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_NoiseGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
...
static void rna_def_modifier_gpencilsmooth(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "SmoothGreasePencilModifierData");
	...
	RNA_def_property_string_sdna(prop, NULL, "vgname");
	RNA_def_property_ui_text(prop, "Vertex Group", "Vertex group name for modulating the deform");
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_SmoothGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
...
static void rna_def_modifier_gpencilsubdiv(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "SubdivGreasePencilModifierData");
...
static void rna_def_modifier_gpencilsimplify(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "SimplifyGreasePencilModifierData");
...
static void rna_def_modifier_gpencilthick(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "ThickGreasePencilModifierData");
	...
	RNA_def_property_string_sdna(prop, NULL, "vgname");
	RNA_def_property_ui_text(prop, "Vertex Group", "Vertex group name for modulating the deform");
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_ThickGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
...
static void rna_def_modifier_gpenciloffset(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "OffsetGreasePencilModifierData");
	...
	RNA_def_property_string_sdna(prop, NULL, "vgname");
	RNA_def_property_ui_text(prop, "Vertex Group", "Vertex group name for modulating the deform");
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_OffsetGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
...
static void rna_def_modifier_gpenciltint(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "TintGreasePencilModifierData");
...
static void rna_def_modifier_gpencilcolor(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "ColorGreasePencilModifierData");
...
static void rna_def_modifier_gpencilopacity(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "OpacityGreasePencilModifierData");
	...
	RNA_def_property_string_sdna(prop, NULL, "vgname");
	RNA_def_property_ui_text(prop, "Vertex Group", "Vertex group name for modulating the deform");
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_OpacityGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
...
static void rna_def_modifier_gpencilinstance(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "InstanceGreasePencilModifierData");
...
static void rna_def_modifier_gpencilbuild(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "BuildGreasePencilModifierData");
...
static void rna_def_modifier_gpencillattice(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "LatticeGreasePencilModifierData");
	...
	RNA_def_property_string_sdna(prop, NULL, "vgname");
	RNA_def_property_ui_text(prop, "Vertex Group", "Vertex group name for modulating the deform");
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_LatticeGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
	...
	RNA_def_property_pointer_funcs(prop, NULL, "rna_LatticeGreasePencilModifier_object_set", NULL, "rna_Lattice_object_poll");
...
static void rna_def_modifier_gpencilhook(BlenderRNA *brna)
{
	...
	RNA_def_struct_sdna(srna, "HookGreasePencilModifierData");
	RNA_def_struct_ui_icon(srna, ICON_HOOK);

	prop = RNA_def_property(srna, "object", PROP_POINTER, PROP_NONE);
	RNA_def_property_ui_text(prop, "Object", "Parent Object for hook, also recalculates and clears offset");
	RNA_def_property_flag(prop, PROP_EDITABLE | PROP_ID_SELF_CHECK);
	RNA_def_property_pointer_funcs(prop, NULL, "rna_HookGreasePencilModifier_object_set", NULL, NULL);
	RNA_def_property_update(prop, 0, "rna_Modifier_dependency_update");
	...
	RNA_def_property_string_sdna(prop, NULL, "vgname");
	RNA_def_property_ui_text(prop, "Vertex Group", "Vertex group name for modulating the deform");
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_HookGreasePencilModifier_vgname_set");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");
...
void RNA_def_greasepencil_modifier(BlenderRNA *brna)
{
	...
	/* data */
	srna = RNA_def_struct(brna, "GreasePencilModifier", NULL);
	RNA_def_struct_ui_text(srna, "GreasePencilModifier", "Modifier affecting the grease pencil object");
	RNA_def_struct_refine_func(srna, "rna_GreasePencilModifier_refine");
	RNA_def_struct_path_func(srna, "rna_GreasePencilModifier_path");
	RNA_def_struct_sdna(srna, "GreasePencilModifierData");

	/* strings */
	prop = RNA_def_property(srna, "name", PROP_STRING, PROP_NONE);
	RNA_def_property_string_funcs(prop, NULL, NULL, "rna_GreasePencilModifier_name_set");
	...
	RNA_def_property_boolean_sdna(prop, NULL, "mode", eGreasePencilModifierMode_Realtime);
	...
	RNA_def_property_boolean_sdna(prop, NULL, "mode", eGreasePencilModifierMode_Render);
	RNA_def_property_override_flag(prop, PROPOVERRIDE_OVERRIDABLE_STATIC);
